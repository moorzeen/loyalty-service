...
* проверка принятых номеров заказов во внешней системе расчёта баллов лояльности;
* начисление за каждый подходящий номер заказа положенного вознаграждения на счёт лояльности пользователя;
* списание баллов лояльности со счета пользователя.
...
2. Пользователь совершает покупку во внешнем интернет-магазине.
3. Заказ попадает во внешнюю систему расчёта баллов лояльности.
...
7. Пользователь списывает доступные баллы лояльности для частичной или полной оплаты последующих заказов во внешнем интернет-магазине.

Примечания:

- пункт 3 должен быть реализован во внешней системе расчёта баллов и не требует участия данного сервиса лояльности.

### Внешняя система расчета баллов лояльности
...
Накопительная система лояльности предоставляет следующие HTTP-хендлеры:
...
Регистрация производится по паре логин/пароль. Каждый логин уникален.
...
Номер заказа проверяется на корректность ввода с помощью [алгоритма Луна](https://ru.wikipedia.org/wiki/Алгоритм_Луна){target="_blank"}.
